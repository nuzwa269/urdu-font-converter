...
(function () {
  ...
  var FONTS = [
    {
      ...
      download: "https://www.cdnfonts.com/jameel-noori-nastaleeq.font",
    },
    {
      id: "alqalam",
      ...
      fallback: "'Noto Nastaliq Urdu', serif",
      download: "https://www.cdnfonts.com/alqalam-taj-nastaleeq.font",
    },
    {
      id: "alvi",
      name: "علوی نستعلیق",
      ...
      fallback: "'Noto Nastaliq Urdu', serif",
      download: "https://www.cdnfonts.com/alvi-nastaleeq.font",
    },
    {
      id: "mehr",
      name: "مہر نستعلیق",
      ...
      fallback: "'Noto Nastaliq Urdu', serif",
      download: "https://fonts.google.com/specimen/Mehr+Nastaliq",
    },
    {
      id: "gulzar",
      name: "گلزار",
      ...
      fallback: "'Noto Nastaliq Urdu', serif",
      download: "https://fonts.google.com/specimen/Gulzar",
    },
    {
      id: "noto",
  ...
  var RATIOS = [
    { id: "1:1", label: "1:1 انسٹا/فیس بک", maxWidth: 420 },
    { id: "9:16", label: "9:16 ریلز/ٹک ٹاک", maxWidth: 360 },
    { id: "16:9", label: "16:9 یوٹیوب/فیس بک", maxWidth: 560 },
    { id: "4:5", label: "4:5 انسٹا پوسٹ", maxWidth: 420 },
    { id: "3:4", label: "3:4 پورٹریٹ", maxWidth: 390 },
    { id: "4:3", label: "4:3 لینڈاسکیپ", maxWidth: 500 },
    { id: "free", label: "آزاد", maxWidth: 520 },
  ];
  ...
  function frameStyle(frame, fg) {
    ...
    switch (frame) {
      case "thin":
        return { border: "2px solid " + c, borderRadius: "12px" };
      case "thick":
        return { border: "6px solid " + c, borderRadius: "14px" };
      case "double":
        return { border: "6px double " + c, borderRadius: "12px" };
      case "dashed":
        return { border: "3px dashed " + c, borderRadius: "14px" };
      case "dotted":
        return { border: "3px dotted " + c, borderRadius: "14px" };
      case "inset":
        return {
          border: "2px solid " + c,
          outline: "1px solid " + c,
      ...
      case "shadow":
        return {
          borderRadius: "14px",
          boxShadow: "0 18px 40px -10px " + c + "66, 0 6px 18px " + c + "33",
        };
      case "ring":
        return { borderRadius: "9999px", border: "3px solid " + c };
      case "corners":
        return {
          borderRadius: "4px",
          backgroundImage:
      ...
      case "klasik":
        return {
          border: "2px solid " + c,
          boxShadow:
            "inset 0 0 0 6px transparent, inset 0 0 0 7px " +
            c +
            ", inset 0 0 0 11px transparent, inset 0 0 0 12px " +
            c,
          borderRadius: "10px",
        };
      case "mughal":
      ...
      case "qitaa":
        return {
          ...
          backgroundPosition:
            "10px 10px, calc(100% - 10px) 10px, 10px calc(100% - 10px), calc(100% - 10px) calc(100% - 10px)",
        };
      case "manuscript":
        return {
          border: "3px double " + c,
          borderRadius: "6px",
          boxShadow:
            "inset 0 0 0 8px transparent, inset 0 0 0 9px " + c + "55, 0 8px 24px " + c + "33",
        };
      case "naqsh":
        return {
      ...
      case "arabesque":
        return {
          ...
          borderRadius: "16px",
          boxShadow:
            "0 0 0 4px #fde68a55, 0 0 0 6px " +
            c +
            ", " +
            "inset 0 0 0 4px transparent, inset 0 0 0 5px " +
            c +
            "55, " +
            "inset 0 0 0 10px transparent, inset 0 0 0 11px " +
            c,
        };
      default:
        return {};
  ...
  function loadFontCss(href) {
    ...
    l.rel = "stylesheet";
    l.href = href;
    l.setAttribute("data-uc-font", href);
  ...
  function ratioConfig(id) {
    return (
      RATIOS.filter(function (r) {
        return r.id === id;
      })[0] || RATIOS[0]
    );
  }
  ...
  function mount(elementId, config) {
    ...
    FONTS.forEach(function (f) {
      state.styles[f.id] = Object.assign({}, DEFAULT_STYLE);
    });

    function allFonts() {
      return FONTS.concat(state.customFonts);
    }
    ...
    var brandInput = el("input", {
      class: "uc-input",
      dir: "rtl",
      maxlength: "60",
      placeholder: "اختیاری — اپنا نام یا برانڈ",
    });
    ...
    var uploadBtn = el(
      ...
      "⬆ اپنا فونٹ اپ لوڈ کریں",
    );
    var uploadHint = el(
      "div",
      { class: "uc-hint" },
      "TTF, OTF, WOFF, WOFF2 — صرف آپ کے براؤزر میں شامل ہوگا، اپ لوڈ نہیں ہوگا۔",
    );
    ...
    function buildCard(font) {
      ...
      var header = el("div", { class: "uc-row between" }, [
        ...
        el("div", { class: "uc-row" }, [
          ...
          el(
            "button",
            {
              class: "uc-btn sm" + (state.activeId === font.id ? " active" : ""),
              type: "button",
              "data-act": "edit",
              onclick: function () {
                state.activeId = font.id;
                renderAll();
              },
            },
            state.activeId === font.id ? "✓ منتخب" : "ایڈٹ",
          ),
        ]),
      ]);

      var preview = el("div", { class: "uc-preview" });
      var content = el("div", { class: "uc-preview-content" });
      ...
      var actions = el("div", { class: "uc-row", style: { marginTop: "10px" } }, [
        ...
        font.download
          ? el(
              "a",
              { class: "uc-btn", href: font.download, target: "_blank", rel: "noopener" },
              "فونٹ ڈاؤن لوڈ",
            )
          : null,
        font.id.indexOf("custom-") === 0
          ? el(
              "button",
              {
                class: "uc-btn",
    ...
    function buildControls(container, font) {
      ...
      PRESETS.forEach(function (p) {
        var sw = el("button", {
          class: "uc-swatch" + (st.fg === p.fg && st.bg === p.bg ? " active" : ""),
          type: "button",
          title: p.name,
          onclick: function () {
            st.fg = p.fg;
            st.bg = p.bg;
            rerenderCard(font.id);
            buildControls(container, font);
          },
        });
      ...
      // colors
      var fgInput = el("input", {
        type: "color",
        value: st.fg,
        style: { width: "44px", height: "36px", border: "none", background: "transparent" },
      });
      ...
      var bgInput = el("input", {
        type: "color",
        value: typeof st.bg === "string" && st.bg.charAt(0) === "#" ? st.bg : "#ffffff",
        style: { width: "44px", height: "36px", border: "none", background: "transparent" },
      });
      ...
      sizeRange.addEventListener("input", function () {
        ...
        rerenderCard(font.id);
        sizeShow.textContent = st.size + "px";
      });
      var sizeShow = el("span", null, st.size + "px");

      var lhRange = el("input", {
        type: "range",
        min: "1",
        max: "3.2",
        step: "0.1",
      ...
      lhRange.addEventListener("input", function () {
        st.lineHeight = +lhRange.value;
        rerenderCard(font.id);
        lhShow.textContent = st.lineHeight.toFixed(1);
      });
      ...
      function styleBtn(label, key) {
        var b = el(
          "button",
          {
            class: "uc-btn sm" + (st[key] ? " active" : ""),
            type: "button",
            onclick: function () {
              st[key] = !st[key];
              rerenderCard(font.id);
              b.className = "uc-btn sm" + (st[key] ? " active" : "");
            },
          },
          label,
        );
      ...
      function alignBtn(label, val) {
        var b = el(
          "button",
          {
            class: "uc-btn sm" + (st.align === val ? " active" : ""),
            type: "button",
            onclick: function () {
              st.align = val;
              rerenderCard(font.id);
      ...
      RATIOS.forEach(function (r) {
        ratioRow.appendChild(
          el(
            "button",
            {
              class: "uc-btn sm" + (st.ratio === r.id ? " active" : ""),
              type: "button",
              onclick: function () {
                st.ratio = r.id;
                rerenderCard(font.id);
      ...
      FRAMES.forEach(function (fr) {
        var chip = el(
          "div",
          {
            class: "uc-frame-chip" + (st.frame === fr.id ? " active" : ""),
            onclick: function () {
              st.frame = fr.id;
              rerenderCard(font.id);
              buildControls(container, font);
        ...
        applyStyles(
          chip,
          Object.assign({ width: "64px", height: "44px" }, frameStyle(fr.id, st.fg)),
        );
      ...
      var sbToggle = el("label", { class: "uc-toggle" }, [
        (function () {
          ...
          c.checked = st.sentenceBreak;
          c.addEventListener("change", function () {
            st.sentenceBreak = c.checked;
            rerenderCard(font.id);
          });
          return c;
        })(),
      ...
      container.appendChild(
        el("div", { class: "uc-label", style: { marginTop: "10px" } }, "کسٹم رنگ"),
      );
      container.appendChild(colorsRow);
      container.appendChild(
        el("div", { class: "uc-label", style: { marginTop: "10px" } }, "فونٹ سائز"),
      );
      container.appendChild(el("div", { class: "uc-row" }, [sizeRange, sizeShow]));
      container.appendChild(
        el("div", { class: "uc-label", style: { marginTop: "10px" } }, "لائن ہائٹ"),
      );
      container.appendChild(el("div", { class: "uc-row" }, [lhRange, lhShow]));
      container.appendChild(
        el("div", { class: "uc-label", style: { marginTop: "10px" } }, "اسٹائل"),
      );
      container.appendChild(
        el("div", { class: "uc-row" }, [
          styleBtn("B", "bold"),
          styleBtn("I", "italic"),
          styleBtn("U", "underline"),
          styleBtn("سایہ", "shadow"),
          alignBtn("→", "right"),
          alignBtn("≡", "center"),
          alignBtn("←", "left"),
        ]),
      ...
      container.appendChild(
        el(
          "div",
          { class: "uc-label", style: { marginTop: "10px" } },
          "کارڈ سائز (سوشل میڈیا ریشو)",
        ),
      );
    ...
    function rerenderCard(id) {
      var font = allFonts().filter(function (f) {
        return f.id === id;
      })[0];
      if (!font) return;
      var ref = cardRefs[id];
      ...
      var ratio = ratioConfig(st.ratio);
      ...
      prev.style.minHeight = st.ratio === "free" ? "120px" : "";
      prev.style.aspectRatio = st.ratio === "free" ? "" : st.ratio.replace(":", " / ");
      prev.style.maxWidth = ratio.maxWidth + "px";
      prev.style.justifyContent =
        st.align === "right" ? "flex-end" : st.align === "left" ? "flex-start" : "center";
      applyStyles(
        prev,
        Object.assign(
          {
            ...
            minHeight: st.ratio === "free" ? "120px" : "",
            aspectRatio: st.ratio === "free" ? "" : st.ratio.replace(":", " / "),
            maxWidth: ratio.maxWidth + "px",
            alignItems: "center",
            justifyContent:
              st.align === "right" ? "flex-end" : st.align === "left" ? "flex-start" : "center",
    ...
    function randomDesign(id) {
      ...
      var sizes = [18, 20, 24, 28, 32, 36];
      var lhs = [1.5, 1.7, 1.9, 2.1, 2.3];
      st.fg = p.fg;
      st.bg = p.bg;
      ...
      if (state.activeId === id)
        buildControls(
          cardRefs[id].controls,
          allFonts().filter(function (f) {
            return f.id === id;
          })[0],
        );
    }
    ...
    function removeCustomFont(id) {
      state.customFonts = state.customFonts.filter(function (f) {
        return f.id !== id;
      });
    ...
    function downloadPng(font) {
      ...
      var ready =
        document.fonts && document.fonts.load
          ? document.fonts
              .load(st.size + 'px "' + family + '"', state.text || SAMPLE)
              .catch(function () {})
          : Promise.resolve();
      ready
        .then(function () {
        ...
        .catch(function (e) {
          console.error(e);
          alert("PNG ڈاؤن لوڈ میں مسئلہ آیا");
        });
    }
